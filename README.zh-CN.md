...
<p align="center">
  <a href="docs/media/nomi-canvas-group-wechat-2026-09-08.jpg"><img src="docs/media/nomi-canvas-group-wechat-2026-09-08.jpg" alt="Nomi 用户群微信二维码" width="220" /></a>
  &nbsp;&nbsp;
...
微信群与作者二维码在 README 首屏（[群二维码](docs/media/nomi-canvas-group-wechat-2026-09-08.jpg) · [作者二维码](docs/media/qingyang-wechat.jpg)，或直接加微信 **TZ857886159**）。
...
群二维码已放在 README 首屏；也可以[打开群二维码原图](docs/media/nomi-canvas-group-wechat-2026-09-08.jpg)。二维码不可用时，添加作者微信 **TZ857886159** 拉你进群。
