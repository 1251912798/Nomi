...
基线 807c475d6。全新隔离项目；创作/生成各 5 句，零媒体。原生 pi 文件为无损 gzip；逐句按输入次序定位，trace.jsonl 关联文件及 SHA256。模型认证另预留 ¥0.01（单次文本连通探测，未返回 usage），10 句 DeepSeek 峰值/汇率8上界 ¥0.430618，总上界 ¥0.440618。
