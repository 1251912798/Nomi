...
export function normalizeResidentToolProjection(input: Partial<ResidentToolProjection>): ResidentToolProjection {
  return Object.freeze({
    label: redactResidentSensitiveText(String(input.label ?? '')),
    effect: redactResidentSensitiveText(String(input.effect ?? '')),
    target: redactResidentSensitiveText(String(input.target ?? '')),
    technicalDetails: redactResidentSensitiveText(String(input.technicalDetails ?? '')),
    input: redactResidentSensitiveText(String(input.input ?? '')),
    output: redactResidentSensitiveText(String(input.output ?? '')),
