...
export default function TimelineTextTrack(): JSX.Element {
  ...
  return (
    <div
      ...
      data-testid="timeline-text-track"
    ...
    >
      ...
      >
        ...
        <span className="min-w-0 flex-1 overflow-hidden text-ellipsis whitespace-nowrap">
          {t('timelineEditor.textTrack.title')}
        </span>
        <span
          className={cn(
        ...
        {textClips.map((clip) => {
          ...
          return (
            ...
            >
              ...
              <span className="min-w-0 flex-1 overflow-hidden text-ellipsis whitespace-nowrap">
                {clip.text || t('timelineEditor.textTrack.empty')}
              </span>
              <span
                role="separator"
                aria-label={t('timelineEditor.textTrack.resizeLeft')}
              ...
              <span
                role="separator"
                aria-label={t('timelineEditor.textTrack.resizeRight')}
