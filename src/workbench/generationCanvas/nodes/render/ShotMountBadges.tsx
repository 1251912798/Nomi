...
/**
 * 切片2：镜头面「挂了哪些设定卡」徽章（框外标签行）——不选中也能一眼看出挂了谁，
  ...
  return (
    ...
    >
      ...
      {rest.length > 0 ? (
        <span
          title={restTitle}
          className="pointer-events-auto cursor-default py-[3px] px-2 rounded-nomi-sm text-micro text-nomi-ink-60"
        >
          +{rest.length}
        </span>
      ) : null}
