...
export function NodeGenerationStatus({ node }: { node: GenerationCanvasNode }): JSX.Element | null {
  ...
  return <span className="inline-flex min-w-0 [&_[data-generation-status]]:bg-transparent [&_[data-generation-status]]:text-micro [&_[data-generation-status]]:font-normal [&_[data-process-dot]]:bg-nomi-ink-30"><GenerationStatusBar feedback={feedback} /></span>
}
