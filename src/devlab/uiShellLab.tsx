...
const NODE_EMPTY_COPY: Record<CanvasToolbarNodeKind, {
  ...
  video_depth_process: { name: '深度视频节点空态', titleKey: 'generationCommon.nodeEmpty.video_depth_process.title', descriptionKey: 'generationCommon.nodeEmpty.video_depth_process.description' },
}
