export const zhGenerationCommon = {
  ...
  nodeEmpty: {
    ...
    video_depth_process: { title: '深度视频节点', description: '选一段画布上的视频，在本机跑出深度视频当动作参考。' },
  ...
  canvas: {
    ...
    group: {
      ...
      // ── 框工具第一档（2026-09-06 拍板）──
      frameTool: '画框',
      frameToolHint: '拖出一个框，把镜头圈到一起 · F',
      frameToolArmed: '正在画框 · 拖出一个矩形，Esc 取消',
      untitledFrame: '未命名框',
      descriptionPlaceholder: '加一句说明',
      renameAria: '重命名框「{{name}}」',
      describeAria: '编辑框「{{name}}」的说明',
      moreActions: '框「{{name}}」的更多操作',
      menuEdit: '改名 / 说明',
      menuGenerate: '生成整框',
      menuTimeline: '整框进时间轴',
      menuCollapse: '折叠成卡',
...
export const enGenerationCommon = {
  ...
  nodeEmpty: {
    ...
    video_depth_process: { title: 'Depth video node', description: 'Pick a video from the canvas and run a local depth pass to use as a motion reference.' },
  ...
  canvas: {
    ...
    group: {
      ...
      // ── Frame tool, first tier (approved 2026-09-06) ──
      frameTool: 'Draw a frame',
      frameToolHint: 'Drag out a frame to gather shots together · F',
      frameToolArmed: 'Drawing a frame · drag out a rectangle, Esc to cancel',
      untitledFrame: 'Untitled frame',
      descriptionPlaceholder: 'Add a note',
      renameAria: 'Rename frame “{{name}}”',
      describeAria: 'Edit the note on frame “{{name}}”',
      moreActions: 'More actions for frame “{{name}}”',
      menuEdit: 'Rename / note',
      menuGenerate: 'Generate the whole frame',
      menuTimeline: 'Send the whole frame to the timeline',
