export const zhSettings = {
  ...
  general: {
    ...
    telemetry: {
      ...
      statusUnconfigured: '已开启；未配置端点，只在本机记录',
      statusConfigured: '已开启；仅发送白名单频率事件',
      viewSummary: '查看待发 / 已发摘要',
      deleteAll: '删除全部',
      deleteConfirm: '删除本机待发和已发摘要？',
      summary: '待发 {{pending}} 条 · 已发 {{sent}} 条',
      pending: '待发',
      sent: '已发',
    },
    diagnostics: {
  ...
  file: {
    ...
    projectLocationHint: '新项目会放在这里；已有项目位置不变。',
    projectLocationLoading: '正在读取…',
    projectLocationUnavailable: '当前环境不支持更改项目位置',
    projectLocationChange: '更换位置',
    projectLocationReveal: '打开位置',
    projectLocationReset: '恢复默认',
    projectLocationManaged: '当前由启动环境指定，不能在应用内更改。',
    projectLocationConfigured: '可在另一台电脑继续编辑',
    projectLocationCheck: '检查文件夹',
    projectLocationChecking: '检查中…',
    projectLocationCheckSuccess: '文件夹可用。',
    projectLocationSyncTitle: '换电脑继续编辑',
    projectLocationSyncShortHint: '用同步工具同步上面的文件夹。',
    projectLocationSyncSteps: '查看 3 步',
    projectLocationSyncStepsClose: '收起',
    projectLocationSyncStepInstallPrefix: '安装同步工具：',
    projectLocationSyncToolVerySync: '微力同步',
    projectLocationSyncOr: '或',
    projectLocationSyncToolNutstore: '坚果云',
    projectLocationSyncStepInstallSuffix: '。',
    projectLocationSyncStepAdd: '把上面的文件夹添加进去。',
    projectLocationSyncStepWait: '等待同步完成，再在另一台电脑打开 Nomi。',
...
export const enSettings = {
  ...
  general: {
    ...
    telemetry: {
      ...
      statusUnconfigured: 'On; endpoint not configured, recorded locally only',
      statusConfigured: 'On; allowlisted frequency events only',
      viewSummary: 'View pending / sent summary',
      deleteAll: 'Delete all',
      deleteConfirm: 'Delete pending and sent summaries on this device?',
  ...
  file: {
    ...
    projectLocationHint: 'New projects use this location; existing projects stay where they are.',
    projectLocationLoading: 'Loading…',
    projectLocationUnavailable: 'Project location cannot be changed in this environment',
    projectLocationChange: 'Change location',
    projectLocationReveal: 'Open location',
    ...
    projectLocationConfigured: 'Continue editing on another computer',
    projectLocationCheck: 'Check folder',
    projectLocationChecking: 'Checking…',
    projectLocationCheckSuccess: 'Folder is available.',
    projectLocationSyncTitle: 'Continue on another computer',
    projectLocationSyncShortHint: 'Use a sync tool for the folder above.',
    projectLocationSyncSteps: 'See 3 steps',
    projectLocationSyncStepsClose: 'Hide steps',
    projectLocationSyncStepInstallPrefix: 'Install a sync tool:',
    projectLocationSyncToolVerySync: 'VerySync',
    projectLocationSyncOr: 'or',
    projectLocationSyncToolNutstore: 'Nutstore',
    projectLocationSyncStepInstallSuffix: '.',
    projectLocationSyncStepAdd: 'Add the folder above to it.',
    projectLocationSyncStepWait: 'Wait for sync to finish, then open Nomi on the other computer.',
