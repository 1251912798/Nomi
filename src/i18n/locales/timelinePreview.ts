export const zhTimelinePreview = {
  ...
  exportBusyReason: '正在导出（{{stage}} · {{percent}}%），这次导出完成后才能再点',
  exportStageProgress: '{{stage}} · {{percent}}%',
  exportStage: {
    preparing: '准备素材',
    recording: '录制画面',
    converting: '转码封装',
...
export const enTimelinePreview = {
  ...
  exportBusyReason: 'Export in progress ({{stage}} · {{percent}}%) — you can export again once it finishes',
  exportStageProgress: '{{stage}} · {{percent}}%',
  exportStage: {
