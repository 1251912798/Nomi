export const zhTimelineEditor = {
  ...
  transition: {
    pickerTitle: '转场', close: '关闭转场选择器', addDefault: '添加默认叠化（15 帧）', durationLabel: '时长', durationShorter: '转场调短一帧', durationLonger: '转场调长一帧', remove: '删除转场', unsupportedNotice: '预览与导出暂不支持，将保持硬切', fpsHint: '{{fps}} fps',
    types: {
      cut: '硬切',
      dissolve: '叠化',
      fade: '淡入淡出',
...
export const enTimelineEditor = {
  ...
  transition: {
    pickerTitle: 'Transition', close: 'Close transition picker', addDefault: 'Add default dissolve (15 frames)', durationLabel: 'Duration', durationShorter: 'One frame shorter', durationLonger: 'One frame longer', remove: 'Remove transition', unsupportedNotice: 'Preview and export do not support this effect; it remains a hard cut', fpsHint: '{{fps}} fps',
    types: {
      cut: 'Cut',
      dissolve: 'Dissolve',
      fade: 'Fade',
