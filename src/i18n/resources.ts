...
export const zhCN = {
  ...
  library: {
    ...
    syncCorrupt: '项目文件异常',
    syncDetailsReady: '项目已检查',
    syncDetailsReadyHint: '项目清单和素材引用完整，可以在另一台电脑继续。',
    syncDetailsExternal: '发现另一台电脑的项目更新',
    syncDetailsExternalHint: '先确认同步工具已经完成，再重新检查项目。',
    syncDetailsMissing: '项目缺少素材',
    syncDetailsMissingHint: '有 {{count}} 个素材还没有同步到这台电脑。',
...
export const en = {
  ...
  library: {
    ...
    syncCorrupt: 'Project file needs attention',
    syncDetailsReady: 'Project checked',
    syncDetailsReadyHint: 'The project manifest and asset references are complete. You can continue on another computer.',
    syncDetailsExternal: 'A newer project version was found',
    syncDetailsExternalHint: 'Wait for the sync client to finish, then check the project again.',
    syncDetailsMissing: 'Project assets are missing',
    syncDetailsMissingHint: '{{count}} assets are not on this computer yet.',
