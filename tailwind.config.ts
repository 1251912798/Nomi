...
const workbenchBasePlugin = plugin(({ addBase, addUtilities }) => {
  ...
  addBase({
    ':root': {
      ...
      '--nomi-axis-y': '#16a34a',
      '--nomi-axis-z': '#3b82f6',
      // 导演台时间轴片段 / 关键帧色（主题无关——与 3D 轴向色同理：路径 sky-600 / 特写 rose-600 / 动作 emerald-700 / 姿态 amber-700 / 视线 indigo-700，
      // 关键帧 路径 sky-400 / 骨骼 amber-400 / 激活 red-500，路径激活边 cyan-400）
      '--nomi-clip-path': '#0084d1',
      '--nomi-clip-closeup': '#ec003f',
      '--nomi-clip-action': '#007a55',
      '--nomi-clip-pose': '#bb4d00',
      '--nomi-clip-lookat': '#432dd7',
      // 片段状态配色：保留 OKLCH 原值，文字/选中白不随主题反转。
      '--nomi-clip-path-hover': 'oklch(68.5% .169 237.323)',
      '--nomi-clip-path-text': 'oklch(97.7% .013 236.62)',
      '--nomi-clip-closeup-hover': 'oklch(64.5% .246 16.439)',
      '--nomi-clip-closeup-text': 'oklch(96.9% .015 12.422)',
      '--nomi-clip-action-hover': 'oklch(59.6% .145 163.225)',
      '--nomi-clip-action-text': 'oklch(95% .052 163.051)',
      '--nomi-clip-pose-hover': 'oklch(66.6% .179 58.318)',
      '--nomi-clip-pose-text': 'oklch(96.2% .059 95.617)',
      '--nomi-clip-lookat-hover': 'oklch(51.1% .262 276.966)',
      '--nomi-clip-lookat-text': 'oklch(93% .034 272.788)',
      '--nomi-clip-path-active-text': 'oklch(98.4% .019 200.873)',
      '--nomi-clip-selected': '#ffffff',
      '--nomi-key-path': '#00bcff',
      '--nomi-key-bone': '#ffb900',
      '--nomi-key-active': '#fb2c36',
      '--nomi-clip-path-active': '#00d3f2',
    ...
    extend: {
      colors: {
        ...
        nomi: {
          ...
          'clip-path': tokenColor('--nomi-clip-path'),
          'clip-closeup': tokenColor('--nomi-clip-closeup'),
          'clip-action': tokenColor('--nomi-clip-action'),
          'clip-pose': tokenColor('--nomi-clip-pose'),
          'clip-lookat': tokenColor('--nomi-clip-lookat'),
          'clip-path-hover': tokenColor('--nomi-clip-path-hover'),
          'clip-path-text': tokenColor('--nomi-clip-path-text'),
          'clip-closeup-hover': tokenColor('--nomi-clip-closeup-hover'),
          'clip-closeup-text': tokenColor('--nomi-clip-closeup-text'),
          'clip-action-hover': tokenColor('--nomi-clip-action-hover'),
          'clip-action-text': tokenColor('--nomi-clip-action-text'),
          'clip-pose-hover': tokenColor('--nomi-clip-pose-hover'),
          'clip-pose-text': tokenColor('--nomi-clip-pose-text'),
          'clip-lookat-hover': tokenColor('--nomi-clip-lookat-hover'),
          'clip-lookat-text': tokenColor('--nomi-clip-lookat-text'),
          'clip-path-active-text': tokenColor('--nomi-clip-path-active-text'),
          'clip-selected': tokenColor('--nomi-clip-selected'),
          'key-path': tokenColor('--nomi-key-path'),
          'key-bone': tokenColor('--nomi-key-bone'),
          'key-active': tokenColor('--nomi-key-active'),
          'clip-path-active': tokenColor('--nomi-clip-path-active'),
