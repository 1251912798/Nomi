...
export const laneModelReadDefinition = {
  ...
  description: 'Read complete current model modes, parameters and reference slots; target must be models and optional modelKey narrows the catalog before choosing parameters or references.',
