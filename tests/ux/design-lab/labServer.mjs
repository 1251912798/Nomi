 ...
 */
export const LAB_ROLES = ['visual', 'walk-agent-panel-v4', 'walk-editing', 'walk-storyboard', 'walk-host-config', 'walk-vendor-order', 'walk-canvas-add-menu', 'walk-settings', 'walk-canvas-frame', 'walk-depth-action']
