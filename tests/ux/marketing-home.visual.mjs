...
async function auditStandardCase(browser, testCase) {
  ...
  assert(
    facts.groupQrVisible && facts.groupQrSource === '/assets/group-wechat-2026-09-08.jpg',
...
async function auditNoJavaScript(browser, pathName, locale, claim) {
  ...
  assert(qr === '/assets/group-wechat-2026-09-08.jpg' && business > 0, `${locale}: no-JS QR and project paths remain`)
  assert(
...
async function auditBlockedMedia(browser) {
  ...
  assert(
    facts.qr === '/assets/group-wechat-2026-09-08.jpg' && facts.business,
