...
export const L1_SCENARIOS: readonly L1Scenario[] = [
  ...
  scenario('G3', 'generation', 'Preserve nested parameters while creating and previewing', [turn('Preview this structured generation plan.',
    ...
    calls(domain('preview-g3', 'nomi_generation_plan', { operation: 'preview', operationId: 'gen-3' }, { operationId: 'gen-3', ready: true })), say('Nested parameters survived the preview.'))]),
